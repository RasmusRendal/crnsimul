...
//! Class that implements and approximates a solution to an ODE using the Euler
//! method
...
public:
	...
	/*! This function implements the Euler method and gets the next state of the
		...
		After each iteration the finished flag is evaluated in regards to the
		threshold. The mState.time property represents this mentioned t_value*/
